...
const props = defineProps<{ words: Word[]; masteredWordIds: string[]; reviewRecords: Record<string, ReviewRecord> }>()
const emit = defineEmits<{ mastery: [word: Word]; remove: [word: Word]; review: [word: Word, result: ReviewResult]; shelf: [] }>()
